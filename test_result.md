...
agent_communication:
  ...
  - agent: "main"
    message: "FIXED 2 CRITICAL BUGS: 1) Smart rest day logic - changed to track max_consecutive_count instead of final count. Now correctly identifies max consecutive workout days (e.g., Mon/Tue/Thu/Fri has max 2 consecutive). 2) Week start Monday - added logic to align start_date to nearest past Monday before generating schedule. Schedule now properly starts from Monday instead of current day. Please retest both features."
  - agent: "testing"
